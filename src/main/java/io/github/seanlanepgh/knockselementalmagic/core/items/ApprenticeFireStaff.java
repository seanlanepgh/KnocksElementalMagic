...
public class ApprenticeFireStaff extends KnocksBaseItem {

    public ApprenticeFireStaff(Properties props) {
        super(props);
    }
    @Override
    public void releaseUsing(ItemStack stack,Level Level, LivingEntity entityLiving, int timeLeft) {
        ...
        if (entityLiving instanceof Player) {
            ...
            if (!Level.isClientSide) {
                BlazeBolt abstractarrowentity = createArrow(Level, stack, playerentity);
    ...
    public static void reload(Player user, InteractionHand hand) {
        if (user.getItemInHand(hand).getItem() instanceof ApprenticeFireStaff) {
