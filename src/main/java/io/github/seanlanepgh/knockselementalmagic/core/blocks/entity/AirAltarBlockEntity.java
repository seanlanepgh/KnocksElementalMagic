package io.github.seanlanepgh.knockselementalmagic.core.blocks.entity;
...
public class AirAltarBlockEntity extends BlockEntity implements Nameable {
    public int time;
    public float flip;
    public float oFlip;
    public float flipT;
    ...
    public AirAltarBlockEntity(BlockPos p_155501_, BlockState p_155502_) {
        super(KnocksBlockEntityTypes.AIR_ALTAR.get(), p_155501_, p_155502_);
    }
    ...
    public static void bookAnimationTick(Level p_155504_, BlockPos p_155505_, BlockState p_155506_, AirAltarBlockEntity p_155507_) {
