...
public class IceAltarBlockEntity extends BlockEntity implements Nameable {
    public int time;
    public float flip;
    public float oFlip;
    public float flipT;
    ...
    public IceAltarBlockEntity(BlockPos p_155501_, BlockState p_155502_) {
        super(KnocksBlockEntityTypes.ICE_ALTAR.get(), p_155501_, p_155502_);
    }
    ...
    public static void bookAnimationTick(Level p_155504_, BlockPos p_155505_, BlockState p_155506_, IceAltarBlockEntity p_155507_) {
