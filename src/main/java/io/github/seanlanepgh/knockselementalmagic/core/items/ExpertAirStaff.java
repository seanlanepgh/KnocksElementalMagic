...
import io.github.seanlanepgh.knockselementalmagic.entity.projectile.TornadoBlast;
...
import software.bernie.geckolib3.util.GeckoLibUtil;
    ...
    public class ExpertAirStaff extends KnocksBaseItem {

        public ExpertAirStaff(Properties props) {
            super(props);
        }
        ...
        public void releaseUsing(ItemStack stack, Level Level, LivingEntity entityLiving, int timeLeft) {
            ...
            if (entityLiving instanceof Player) {
                ...
                if (!Level.isClientSide) {
                    TornadoBlast abstractarrowentity = createArrow(Level, stack, playerentity);
        ...
        public TornadoBlast createArrow(Level level, ItemStack stack, LivingEntity shooter) {
            float j = EnchantmentHelper.getTagEnchantmentLevel(Enchantments.POWER_ARROWS, stack);
            TornadoBlast arrowentity = new TornadoBlast(level, shooter,
                    (2.0F + (j * 2.0F)));
            return arrowentity;
        }
