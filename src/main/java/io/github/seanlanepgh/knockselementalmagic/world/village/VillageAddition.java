package io.github.seanlanepgh.knockselementalmagic.world.village;
...
public class VillageAddition {
    ...
    public static void addNewVillageBuilding(final ServerAboutToStartEvent event) {
        ...
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                ...
                "knockselementalmagic:air_wizard_tower", 5);

        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/plains/houses"),
                "knockselementalmagic:ice_wizard_tower", 5);

        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/plains/houses"),
                "knockselementalmagic:earth_wizard_tower", 5);

//        addBuildingToPool(templatePoolRegistry, processorListRegistry,
//                new ResourceLocation("minecraft:village/plains/houses"),
//                "knockselementalmagic:fire_wizard_tower", 250);

        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/desert/houses"),
                "knockselementalmagic:desert_fire_wizard_tower", 5);
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/savanna/houses"),
                "knockselementalmagic:savanna_fire_wizard_tower", 5);

        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/snowy/houses"),
                "knockselementalmagic:snowy_ice_wizard_tower", 5);

        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/taiga/houses"),
                "knockselementalmagic:snowy_wizard_tower", 5);


        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/taiga/houses"),
                "knockselementalmagic:taiga_earth_wizard_tower", 5);
        //addBuildingToPool(templatePoolRegistry, processorListRegistry,
        //        new ResourceLocation("minecraft:village/savanna/houses"),
