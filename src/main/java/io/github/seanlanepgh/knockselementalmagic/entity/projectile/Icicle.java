...
public class Icicle extends AbstractHurtingProjectile implements IAnimatable {
    ...
    public Icicle(EntityType<Icicle> icicleEntityType, Level level) {
        super(KnocksEntityTypes.ICICLE.get() ,level);
    }
    public Icicle(EntityType<? extends Icicle> p_36817_, double p_36818_, double p_36819_, double p_36820_, double p_36821_, double p_36822_, double p_36823_, Level p_36824_) {
        super(KnocksEntityTypes.ICICLE.get(), p_36824_);
    ...
    public Icicle(LivingEntity p_36827_, double p_36828_, double p_36829_, double p_36830_, Level p_36831_) {
        super(KnocksEntityTypes.ICICLE.get(), p_36827_.getX(), p_36827_.getY(), p_36827_.getZ(), p_36828_, p_36829_, p_36830_, p_36831_);
        this.setOwner(p_36827_);
        this.setRot(p_36827_.getYRot(), p_36827_.getXRot());
    }

    public Icicle(Level p_36711_, BlizzEntity p_36712_, double p_36713_, double p_36714_, double p_36715_) {
        super(KnocksEntityTypes.ICICLE.get(),p_36711_);
        this.setPos(p_36713_,p_36714_, p_36715_);
    }

//    protected Icicle(EntityType<? extends Icicle> p_36717_, LivingEntity p_36718_, Level p_36719_) {
//        this(KnocksEntityTypes.ICICLE.get(), p_36718_.getX(), p_36718_.getEyeY() - (double)0.1F, p_36718_.getZ(), p_36719_);
//        this.setOwner(p_36718_);
//        if (p_36718_ instanceof Player) {
//            this.pickup = Icicle.Pickup.ALLOWED;
//        }
//
//    }
    ...
    protected void onHitEntity(EntityHitResult p_36757_) {
        ...
        if (entity1 == null) {
           ...
           damagesource = DamageSource.indirectMagic(this, entity);
        ...
        if (entity.hurt(damagesource, (float)i)) {
            ...
            if (!this.level.isClientSide && this.getDeltaMovement().lengthSqr() < 1.0E-7D) {
                if (this.pickup == Icicle.Pickup.ALLOWED) {
    ...
    public void readAdditionalSaveData(CompoundTag p_36761_) {
        ...
        this.pickup = Icicle.Pickup.byOrdinal(p_36761_.getByte("pickup"));
    ...
    public void setOwner(@Nullable Entity p_36770_) {
        ...
        if (p_36770_ instanceof Player) {
            this.pickup = ((Player)p_36770_).getAbilities().instabuild ? Icicle.Pickup.CREATIVE_ONLY : Icicle.Pickup.ALLOWED;
        }
