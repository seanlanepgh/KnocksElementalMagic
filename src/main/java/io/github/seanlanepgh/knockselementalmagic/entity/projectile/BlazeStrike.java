...
public class BlazeStrike extends AbstractArrow implements IAnimatable {
    ...
    public BlazeStrike(EntityType<? extends AbstractArrow> type, Level world) {
        super(type, world);
    }

    public BlazeStrike(Level world, LivingEntity owner) {
        super(KnocksEntityTypes.BLAZE_STRIKE.get(), owner, world);
        this.shooter = owner;
    }

    public BlazeStrike(Level world, LivingEntity owner, float damage) {
        super(KnocksEntityTypes.BLAZE_STRIKE.get(), owner, world);
        this.shooter = owner;
