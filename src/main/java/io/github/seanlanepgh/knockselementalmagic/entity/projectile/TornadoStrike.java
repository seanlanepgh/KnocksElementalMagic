...
public class TornadoStrike extends AbstractArrow implements IAnimatable {
    ...
    public TornadoStrike(EntityType<? extends AbstractArrow> type, Level world) {
        super(type, world);
    }

    public TornadoStrike(Level world, LivingEntity owner) {
        super(KnocksEntityTypes.TORNADO_STRIKE.get(), owner, world);
        this.shooter = owner;
    }

    public TornadoStrike(Level world, LivingEntity owner, float damage) {
        super(KnocksEntityTypes.TORNADO_STRIKE.get(), owner, world);
        this.shooter = owner;
    ...
    public void tick() {
        ...
        if (this.inAir && !flag) {
            ...
            if (this.level.isClientSide()) {
                ...
                this.level.addParticle(ParticleTypes.CLOUD, true, x, this.getY(), z, 0, 0, 0);
            }
        }
    }
