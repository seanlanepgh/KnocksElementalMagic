...
public class EarthSpike extends EvokerFangs  implements IAnimatable {
    ...
    public EarthSpike( EntityType<? extends EarthSpike> p_32627_, Level p_32628_) {
        super(p_32627_, p_32628_);
    }


    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.elemental_crystal_attack.idle", true));
        return PlayState.CONTINUE;
    }

    @Override
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<EarthSpike>(this, "controller", 0, this::predicate));
    }
    ...
    public EarthSpike(Level p_36926_, double p_36927_, double p_36928_, double p_36929_, float p_36930_, int p_36931_, LivingEntity p_36932_) {
        this( KnocksEntityTypes.EARTH_SPIKE.get(), p_36926_);
            ...
            if (this.clientSideAttackStarted) {
                ...
                if (this.lifeTicks == 14) {
                    for(int i = 0; i < 12; ++i) {
                        ...
                        this.level.addParticle(ParticleTypes.ASH, d0, d1 + 1.0D, d2, d3, d4, d5);
                    }
                }
            }
