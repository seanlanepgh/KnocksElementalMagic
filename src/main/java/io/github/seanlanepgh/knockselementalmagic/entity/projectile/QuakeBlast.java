...
public class QuakeBlast extends AbstractArrow implements IAnimatable {
    ...
    public QuakeBlast(EntityType<? extends AbstractArrow> type, Level world) {
        super(type, world);
    }

    public QuakeBlast(Level world, LivingEntity owner) {
        super(KnocksEntityTypes.QUAKE_BLAST.get(), owner, world);
        this.shooter = owner;
    }

    public QuakeBlast(Level world, LivingEntity owner, double damage) {
        super(KnocksEntityTypes.QUAKE_BLAST.get(), owner, world);
        this.shooter = owner;
        this.projectiledamage = (float) damage;
    }

    public QuakeBlast(Level world, LivingEntity owner, double d2, double d3, double d4, float damage) {
        super(KnocksEntityTypes.QUAKE_BLAST.get(), owner, world);
        this.shooter = owner;
