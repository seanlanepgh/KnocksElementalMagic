...
public class BlizzBolt extends AbstractArrow implements IAnimatable {
	...
	public BlizzBolt(EntityType<? extends AbstractArrow> type, Level world) {
		super(type, world);
	}

	public BlizzBolt(Level world, LivingEntity owner) {
		super(KnocksEntityTypes.BLIZZ_BOLT.get(), owner, world);
		this.shooter = owner;
	}

	public BlizzBolt(Level world, LivingEntity owner, float damage) {
		super(KnocksEntityTypes.BLIZZ_BOLT.get(), owner, world);
		this.shooter = owner;
