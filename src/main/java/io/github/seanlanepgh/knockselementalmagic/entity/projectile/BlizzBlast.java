...
public class BlizzBlast extends AbstractHurtingProjectile implements IAnimatable {
    ...
    public BlizzBlast(EntityType<BlizzBlast> entity, Level world) {
        super(entity, world);
    }
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<BlizzBlast>(this, "controller", 0, this::predicate));
    }
    ...
    public BlizzBlast(Level worldIn, LivingEntity shooter, double accelX, double accelY, double accelZ,
                     float directHitDamage) {
        super(KnocksEntityTypes.BLIZZ_BLAST.get(), shooter, accelX, accelY, accelZ, worldIn);
        this.directHitDamage = directHitDamage;
    }

    public BlizzBlast(Level worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
    ...
    public void remove(RemovalReason reason) {
        ...
        areaeffectcloudentity.setParticle(KnocksParticles.SNOWFLAKE.get());
