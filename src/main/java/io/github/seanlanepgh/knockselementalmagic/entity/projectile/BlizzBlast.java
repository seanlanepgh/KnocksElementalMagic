...
public class BlizzBlast extends AbstractArrow implements IAnimatable {
    ...
    public BlizzBlast(EntityType<? extends AbstractArrow> type, Level world) {
        super(type, world);
    }

    public BlizzBlast(Level world, LivingEntity owner) {
