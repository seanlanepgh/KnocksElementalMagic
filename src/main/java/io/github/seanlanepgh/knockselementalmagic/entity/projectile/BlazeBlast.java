...
public class BlazeBlast extends AbstractHurtingProjectile implements IAnimatable {
    ...
    public BlazeBlast(EntityType<BlazeBlast> entity, Level world) {
        super(entity, world);
    }
    ...
    public BlazeBlast(Level worldIn, LivingEntity shooter, double accelX, double accelY, double accelZ,
                     float directHitDamage) {
        super(KnocksEntityTypes.BLAZE_BOLT.get(), shooter, accelX, accelY, accelZ, worldIn);
        this.directHitDamage = directHitDamage;
    }

    public BlazeBlast(Level worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
