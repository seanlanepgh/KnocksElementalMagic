...
public class BlizzStrike extends AbstractArrow implements IAnimatable {
    ...
    public BlizzStrike(EntityType<? extends AbstractArrow> type, Level world) {
        super(type, world);
    }

    public BlizzStrike(Level world, LivingEntity owner) {
        super(KnocksEntityTypes.BLIZZ_STRIKE.get(), owner, world);
        this.shooter = owner;
    }

    public BlizzStrike(Level world, LivingEntity owner, float damage) {
        super(KnocksEntityTypes.BLIZZ_STRIKE.get(), owner, world);
        this.shooter = owner;
