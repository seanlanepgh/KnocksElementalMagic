...
public class QuakeStrike extends AbstractArrow implements IAnimatable {
    ...
    public QuakeStrike(EntityType<? extends AbstractArrow> type, Level world) {
        super(type, world);
    }

    public QuakeStrike(Level world, LivingEntity owner, double d2, double d3, double d4, float damage) {
        super(KnocksEntityTypes.QUAKE_STRIKE.get(), owner, world);
        this.shooter = owner;
    }

    public QuakeStrike(Level world, LivingEntity owner, float damage) {
        super(KnocksEntityTypes.QUAKE_STRIKE.get(), owner, world);
        this.shooter = owner;
    ...
    public void tick() {
        ...
        if (this.inAir && !flag) {
            ...
            if (this.level.isClientSide()) {
                ...
                this.level.addParticle(ParticleTypes.ASH, true, x, this.getY(), z, 0, 0, 0);
            }
        }
    }
