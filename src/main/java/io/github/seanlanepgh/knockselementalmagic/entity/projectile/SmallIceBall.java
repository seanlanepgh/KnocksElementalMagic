...
public class SmallIceBall extends AbstractHurtingProjectile implements ItemSupplier {

	private static final EntityDataAccessor<ItemStack> DATA_ITEM_STACK = SynchedEntityData.defineId(SmallIceBall.class,
			EntityDataSerializers.ITEM_STACK);

	public SmallIceBall(EntityType<?> p_37364_, Level p_37365_) {
		super((EntityType<? extends AbstractHurtingProjectile>) p_37364_, p_37365_);
	}

	public SmallIceBall(EntityType<? extends AbstractHurtingProjectile> p_36990_, double p_36991_, double p_36992_,
			double p_36993_, double p_36994_, double p_36995_, double p_36996_, Level p_36997_) {
		super(p_36990_, p_36997_);
	}

	public SmallIceBall(EntityType<? extends AbstractHurtingProjectile> p_36999_, LivingEntity p_37000_,
			double p_37001_, double p_37002_, double p_37003_, Level p_37004_) {
		super(p_36999_, p_37004_);
	}

	public SmallIceBall(Level p_37367_, double p_37368_, double p_37369_, double p_37370_, double p_37371_,
			double p_37372_, double p_37373_) {
		super(KnocksEntityTypes.SMALL_ICEBALL.get(), p_37368_, p_37369_, p_37370_, p_37371_, p_37372_, p_37373_, p_37367_);
	}
	...
	protected void onHitEntity(EntityHitResult p_37386_) {
		...
		if (!this.level.isClientSide) {
			...
			if (!entity.canFreeze()) {
				...
				boolean flag = entity.hurt(KWDamageSource.iceBall(this, entity1), 3.0F);
				if (!flag) {
