...
public class IceGolemEntity extends KnocksEntity implements IAnimatable, IAnimationTickable {

    public static final EntityDataAccessor<Integer> RAGE_STATE = SynchedEntityData.defineId(IceGolemEntity.class,
...
//    private UUID persistentAngerTarget;
    ...
    public IceGolemEntity(EntityType<? extends IceGolemEntity> p_28834_, Level p_28835_) {
...
//    }
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<IceGolemEntity>(this, "controller", 0, this::predicate));
        data.addAnimationController(new AnimationController<IceGolemEntity>(this, "controller1", 0, this::predicate1));
    }
