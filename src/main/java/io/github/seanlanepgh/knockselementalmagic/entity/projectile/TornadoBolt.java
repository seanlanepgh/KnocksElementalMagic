...
public class TornadoBolt extends AbstractArrow implements IAnimatable {
    ...
    public TornadoBolt(EntityType<? extends AbstractArrow> type, Level world) {
        super(type, world);
    }

    public TornadoBolt(Level world, LivingEntity owner) {
    ...
    public ItemStack getPickupItem() {
        return new ItemStack(KnocksItems.EARTH_RUNE.get());
    }
