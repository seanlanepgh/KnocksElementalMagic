...
public class RangedAttackGoal extends Goal {
	...
	public RangedAttackGoal(KnocksEntity mob, AbstractRangedAttack attack, double moveSpeedAmpIn) {
		this.entity = mob;
	...
	public RangedAttackGoal(KnocksEntity mob, AbstractRangedAttack attack, double moveSpeedAmpIn, boolean multishot) {
		this.entity = mob;
		this.moveSpeedAmp = moveSpeedAmpIn;
		this.setFlags(EnumSet.of(Goal.Flag.MOVE, Goal.Flag.LOOK));
		this.attack = attack;
