...
public class QuakeEntity extends Monster implements IAnimatable, IAnimationTickable {
    private AnimationFactory factory = new AnimationFactory(this);

    public QuakeEntity(EntityType<? extends Monster> entityType, Level level) {
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(4, new QuakeEntity.QuakeAttackGoal(this));
...
//        this.xpReward = 10;
//    }
    class QuakeAttackGoal extends Goal {
        private final QuakeEntity blaze;
        private int attackStep;
        private int attackTime;
        private int lastSeen;

        public QuakeAttackGoal(QuakeEntity p_32247_) {
            this.blaze = p_32247_;
