...
public class TornadoEntity extends KnocksEntity implements IAnimatable, IAnimationTickable, Enemy {
    ...
    public TornadoEntity(EntityType<? extends KnocksEntity> entityType, Level level) {
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(4, new RangedAttackGoal(this,
                new TornadoEntity.TornadoBoltAttack(this).setProjectileOriginOffset(0.8, 0.5, 0.8)
                        .setDamage(3.0F),1.0F));
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<TornadoEntity>(this, "controller", 0, this::predicate));
    }
    ...
    public class TornadoBoltAttack extends AbstractRangedAttack {
        ...
        public TornadoBoltAttack(TornadoEntity parentEntity, double xOffSetModifier, double entityHeightFraction,
                               double zOffSetModifier, float damage) {
            super(parentEntity, xOffSetModifier, entityHeightFraction, zOffSetModifier, damage);
        }

        public TornadoBoltAttack(TornadoEntity parentEntity) {
            super(parentEntity);
        }
