...
public class SmallEarthBall extends AbstractHurtingProjectile implements ItemSupplier {
	private static final EntityDataAccessor<ItemStack> DATA_ITEM_STACK = SynchedEntityData.defineId(SmallIceBall.class,
			EntityDataSerializers.ITEM_STACK);

	public SmallEarthBall(EntityType<?> p_37364_, Level p_37365_) {
		super((EntityType<? extends AbstractHurtingProjectile>) p_37364_, p_37365_);
	}

	public SmallEarthBall(EntityType<SmallEarthBall> p_36990_, double p_36991_, double p_36992_, double p_36993_,
			double p_36994_, double p_36995_, double p_36996_, Level p_36997_) {
		super(p_36990_, p_36997_);
	}

	public SmallEarthBall(EntityType<SmallEarthBall> p_36999_, LivingEntity p_37000_, double p_37001_, double p_37002_,
			double p_37003_, Level p_37004_) {
		super(p_36999_, p_37004_);
	}

	public SmallEarthBall(Level p_37367_, double p_37368_, double p_37369_, double p_37370_, double p_37371_,
			double p_37372_, double p_37373_) {
		super(KnocksEntityTypes.SMALL_EARTHBALL.get(), p_37368_, p_37369_, p_37370_, p_37371_, p_37372_, p_37373_, p_37367_);
	}
...
//				entity.setTicksFrozen(5);
				...
				boolean flag = entity.hurt(KWDamageSource.earthBall(this, entity1), 3.0F);
				if (!flag) {
