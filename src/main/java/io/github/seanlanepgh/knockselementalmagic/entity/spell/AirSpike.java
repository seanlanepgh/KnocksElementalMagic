...
public class AirSpike extends EvokerFangs  implements IAnimatable {
    ...
    public AirSpike( EntityType<? extends AirSpike> p_32627_, Level p_32628_) {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<AirSpike>(this, "controller", 0, this::predicate));
    }
    ...
    public AirSpike(Level p_36926_, double p_36927_, double p_36928_, double p_36929_, float p_36930_, int p_36931_, LivingEntity p_36932_) {
        this( KnocksEntityTypes.AIR_SPIKE.get(), p_36926_);
