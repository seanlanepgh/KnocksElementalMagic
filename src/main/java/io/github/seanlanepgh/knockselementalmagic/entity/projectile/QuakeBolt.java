...
public class QuakeBolt extends AbstractArrow implements IAnimatable {
    ...
    public QuakeBolt(EntityType<? extends AbstractArrow> type, Level world) {
        super(type, world);
    }

    public QuakeBolt(Level world, LivingEntity owner) {
