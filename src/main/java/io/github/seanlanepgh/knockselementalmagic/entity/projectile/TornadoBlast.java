...
public class TornadoBlast extends AbstractArrow implements IAnimatable {
    ...
    public TornadoBlast(EntityType<? extends AbstractArrow> type, Level world) {
        super(type, world);
    }

    public TornadoBlast(Level world, LivingEntity owner) {
        super(KnocksEntityTypes.TORNADO_BLAST.get(), owner, world);
        this.shooter = owner;
    }

    public TornadoBlast(Level world, LivingEntity owner, double damage) {
        super(KnocksEntityTypes.TORNADO_BLAST.get(), owner, world);
        this.shooter = owner;
        this.projectiledamage = (float) damage;
    }

    public TornadoBlast(Level world, LivingEntity owner, double d2, double d3, double d4, float damage) {
        super(KnocksEntityTypes.TORNADO_BLAST.get(), owner, world);
        this.shooter = owner;
