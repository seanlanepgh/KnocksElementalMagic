...
//			}
	   ...
	   class FireWizardEntityAttackSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
	      ...
	      private void createSpellEntity(double p_32673_, double p_32674_, double p_32675_, double p_32676_, float p_32677_, int p_32678_) {
	         ...
	         if (flag) {
	            FireWizardEntity.this.level.addFreshEntity(new EvokerFangs(FireWizardEntity.this.level, p_32673_, (double)blockpos.getY() + d0, p_32674_, p_32677_, p_32678_, FireWizardEntity.this));
	         }
...
//				 return true;
//			 }
////	            int i = FireWizardEntity.this.level.getNearbyEntities(Vex.class, this.vexCountTargeting, FireWizardEntity.this, FireWizardEntity.this.getBoundingBox().inflate(16.0D)).size();
////	            return FireWizardEntity.this.random.nextInt(8) + 1 > i;
////
//	      }
//
//	      protected int getCastingTime() {
...
//
//	      protected void performSpellCasting() {
//	         ServerLevel serverlevel = (ServerLevel)FireWizardEntity.this.level;
//
//			  BlazeBolt arrowentity = new BlazeBolt(level, FireWizardEntity.this,
//					  (2.0F));
//
////	         for(int i = 0; i < 3; ++i) {
////	            BlockPos blockpos = FireWizardEntity.this.blockPosition().offset(-2 + FireWizardEntity.this.random.nextInt(5), 1, -2 + FireWizardEntity.this.random.nextInt(5));
////	            Vex vex = EntityType.VEX.create(FireWizardEntity.this.level);
////	            vex.moveTo(blockpos, 0.0F, 0.0F);
////	            vex.finalizeSpawn(serverlevel, FireWizardEntity.this.level.getCurrentDifficultyAt(blockpos), MobSpawnType.MOB_SUMMONED, (SpawnGroupData)null, (CompoundTag)null);
////	            vex.setOwner(FireWizardEntity.this);
////	            vex.setBoundOrigin(blockpos);
////	            vex.setLimitedLife(20 * (30 + FireWizardEntity.this.random.nextInt(90)));
//          serverlevel.addFreshEntityWithPassengers(arrowentity);
////	         }
//
//	      }
//
...
//	public class FireWizardBoltAttack extends AbstractRangedAttack {
//
//		public FireWizardBoltAttack(KnocksEntity parentEntity, double xOffSetModifier, double entityHeightFraction,
//									double zOffSetModifier, float damage) {
//			super(parentEntity, xOffSetModifier, entityHeightFraction, zOffSetModifier, damage);
//		}
//
//		public FireWizardBoltAttack(FireWizardEntity parentEntity) {
//			super(parentEntity);
//		}
//
		...
		public Projectile getProjectile(Level world, double d2, double d3, double d4) {
			return new BlazeBolt(world, FireWizardEntity.this, d2, d3, d4, damage);
		}
//	}
}
