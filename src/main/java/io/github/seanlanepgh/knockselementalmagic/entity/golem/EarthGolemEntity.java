...
public class EarthGolemEntity extends KnocksEntity implements IAnimatable, IAnimationTickable {

    public static final EntityDataAccessor<Integer> RAGE_STATE = SynchedEntityData.defineId(EarthGolemEntity.class,
...
//    private UUID persistentAngerTarget;
    ...
    public EarthGolemEntity(EntityType<? extends EarthGolemEntity> p_28834_, Level p_28835_) {
...
//    }
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<EarthGolemEntity>(this, "controller", 0, this::predicate));
        data.addAnimationController(new AnimationController<EarthGolemEntity>(this, "controller1", 0, this::predicate1));
    }
    ...
    public static AttributeSupplier setAttributes() {
        return Monster.createMonsterAttributes().add(Attributes.MOVEMENT_SPEED, 0.5D).add(Attributes.FOLLOW_RANGE, 12.0D).add(Attributes.MAX_HEALTH, 50.0D).build();
    }
