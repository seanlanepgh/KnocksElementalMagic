...
public class AirGolemEntity extends KnocksEntity implements IAnimatable, IAnimationTickable {

    public static final EntityDataAccessor<Integer> RAGE_STATE = SynchedEntityData.defineId(AirGolemEntity.class,
...
//    private UUID persistentAngerTarget;
    ...
    public AirGolemEntity(EntityType<? extends AirGolemEntity> p_28834_, Level p_28835_) {
...
//    }
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<AirGolemEntity>(this, "controller", 0, this::predicate));
        data.addAnimationController(new AnimationController<AirGolemEntity>(this, "controller1", 0, this::predicate1));
    }
