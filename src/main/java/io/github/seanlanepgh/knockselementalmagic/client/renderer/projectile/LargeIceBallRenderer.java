...
import io.github.seanlanepgh.knockselementalmagic.entity.projectile.LargeIceBall;
...
@OnlyIn(Dist.CLIENT)
public class LargeIceBallRenderer extends EntityRenderer<LargeIceBall> {
	 private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(KnocksElementalMagic.MODID , "textures/item/ice_charge.png");
	   private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

	   public  LargeIceBallRenderer(EntityRendererProvider.Context p_173962_) {
	      super(p_173962_);
	   }

	   protected int getBlockLightLevel(LargeIceBall pEntity, BlockPos pPos) {
	      return 0;
	   }

	   public void render(LargeIceBall pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
	...
	@Override
	public ResourceLocation getTextureLocation(LargeIceBall p_114482_) {
