...
import io.github.seanlanepgh.knockselementalmagic.entity.projectile.SmallAirBall;
...
@OnlyIn(Dist.CLIENT)
public class SmallAirBallRenderer extends EntityRenderer<SmallAirBall> {
	 private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(KnocksElementalMagic.MODID, "textures/item/air_charge.png");
	   ...
	   public SmallAirBallRenderer(EntityRendererProvider.Context p_173962_) {
	      super(p_173962_);
	   }

	   protected int getBlockLightLevel(SmallAirBall pEntity, BlockPos pPos) {
	      return 0;
	   }

	   public void render(SmallAirBall pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
	    ...
	    */
	   public ResourceLocation getTextureLocation1(SmallAirBall pEntity) {
	      return TEXTURE_LOCATION;
	   }

	@Override
	public ResourceLocation getTextureLocation(SmallAirBall p_114482_) {
		 return TEXTURE_LOCATION;
	}
}