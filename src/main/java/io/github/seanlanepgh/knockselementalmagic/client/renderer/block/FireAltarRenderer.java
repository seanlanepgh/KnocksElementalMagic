...
@OnlyIn(Dist.CLIENT)
public class FireAltarRenderer implements BlockEntityRenderer<FireAltarBlockEntity> {
   private final BookModel bookModel;

   public FireAltarRenderer(BlockEntityRendererProvider.Context p_173619_) {
      this.bookModel = new BookModel(p_173619_.bakeLayer(ModelLayers.BOOK));
   }

   public void render(FireAltarBlockEntity p_112418_, float p_112419_, PoseStack p_112420_, MultiBufferSource p_112421_, int p_112422_, int p_112423_) {
      p_112420_.pushPose();
      ...
      VertexConsumer vertexconsumer = KnocksMaterial.FIRE_BOOK_LOCATION.buffer(p_112421_, RenderType::entitySolid);
