...
import io.github.seanlanepgh.knockselementalmagic.entity.projectile.LargeAirBall;
...
@OnlyIn(Dist.CLIENT)
public class LargeAirBallRenderer extends EntityRenderer<LargeAirBall> {
	 private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(KnocksElementalMagic.MODID, "textures/item/air_charge.png");
	   ...
	   public LargeAirBallRenderer(EntityRendererProvider.Context p_173962_) {
	      super(p_173962_);
	   }

	   protected int getBlockLightLevel(LargeAirBall pEntity, BlockPos pPos) {
	      return 0;
	   }

	   public void render(LargeAirBall pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
	    ...
	    */
	   public ResourceLocation getTextureLocation1(LargeAirBall pEntity) {
	      return TEXTURE_LOCATION;
	   }

	@Override
	public ResourceLocation getTextureLocation(LargeAirBall p_114482_) {
		 return TEXTURE_LOCATION;
	}
}