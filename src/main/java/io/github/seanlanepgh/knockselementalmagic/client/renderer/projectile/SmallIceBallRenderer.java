...
import io.github.seanlanepgh.knockselementalmagic.entity.projectile.SmallIceBall;
...
@OnlyIn(Dist.CLIENT)
public class SmallIceBallRenderer extends EntityRenderer<SmallIceBall> {
	 private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(KnocksElementalMagic.MODID, "textures/item/ice_charge.png");
	   ...
	   public SmallIceBallRenderer(EntityRendererProvider.Context p_173962_) {
	      super(p_173962_);
	   }
	   ...
	   public void render(SmallIceBall pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
	...
	@Override
	public ResourceLocation getTextureLocation(SmallIceBall p_114482_) {
