...
public class EarthAltarRenderer implements BlockEntityRenderer<EarthAltarBlockEntity> {
   ...
   public EarthAltarRenderer(BlockEntityRendererProvider.Context p_173619_) {
      this.bookModel = new BookModel(p_173619_.bakeLayer(ModelLayers.BOOK));
   }

   public void render(EarthAltarBlockEntity p_112418_, float p_112419_, PoseStack p_112420_, MultiBufferSource p_112421_, int p_112422_, int p_112423_) {
      p_112420_.pushPose();
      ...
      VertexConsumer vertexconsumer = KnocksMaterial.EARTH_BOOK_LOCATION.buffer(p_112421_, RenderType::entitySolid);
