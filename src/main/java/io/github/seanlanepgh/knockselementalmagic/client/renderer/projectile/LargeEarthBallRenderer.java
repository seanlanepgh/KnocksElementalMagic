...
import io.github.seanlanepgh.knockselementalmagic.entity.projectile.LargeEarthBall;
...
@OnlyIn(Dist.CLIENT)
public class LargeEarthBallRenderer extends EntityRenderer<LargeEarthBall> {
	 private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(KnocksElementalMagic.MODID, "textures/item/earth_charge.png");
	   ...
	   public LargeEarthBallRenderer(EntityRendererProvider.Context p_173962_) {
	      super(p_173962_);
	   }

	   protected int getBlockLightLevel(LargeEarthBall pEntity, BlockPos pPos) {
	      return 0;
	   }

	   public void render(LargeEarthBall pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
	    ...
	    */
	   public ResourceLocation getTextureLocation1(LargeEarthBall pEntity) {
	      return TEXTURE_LOCATION;
	   }

	@Override
	public ResourceLocation getTextureLocation(LargeEarthBall p_114482_) {
		 return TEXTURE_LOCATION;
	}
}
