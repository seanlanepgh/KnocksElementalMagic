...
import io.github.seanlanepgh.knockselementalmagic.client.model.spell.FireSpikeModel;
...
public class FireSpikeRenderer extends GeoProjectilesRenderer<FireSpike> {
    public FireSpikeRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new FireSpikeModel());
        // this.shadowRadius = 1.0f;
    }

    @Override
    public ResourceLocation getTextureLocation(FireSpike instance) {
        return new ResourceLocation(KnocksElementalMagic.MODID, "textures/entity/spells/fire_crystal_attack.png");
    }

    @Override
    public RenderType getRenderType(FireSpike animatable, float partialTicks, PoseStack stack,
