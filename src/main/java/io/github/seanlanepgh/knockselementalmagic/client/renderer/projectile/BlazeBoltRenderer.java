...
public class BlazeBoltRenderer extends GeoProjectilesRenderer<BlazeBolt> {
    public BlazeBoltRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new BlazeBoltModel());
        // this.shadowRadius = 1.0f;
    }

    @Override
    public ResourceLocation getTextureLocation(BlazeBolt instance) {
        return new ResourceLocation(KnocksElementalMagic.MODID, "textures/entity/projectiles/blizz_bolt.png");
    }

    @Override
    public RenderType getRenderType(BlazeBolt animatable, float partialTicks, PoseStack stack,
