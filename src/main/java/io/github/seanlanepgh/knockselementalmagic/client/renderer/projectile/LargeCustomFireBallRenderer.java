...
import io.github.seanlanepgh.knockselementalmagic.entity.projectile.LargeCustomFireBall;
...
@OnlyIn(Dist.CLIENT)
public class LargeCustomFireBallRenderer extends EntityRenderer<LargeCustomFireBall> {
	 private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(KnocksElementalMagic.MODID, "textures/item/air_charge.png");
	   private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

	   public LargeCustomFireBallRenderer(EntityRendererProvider.Context p_173962_) {
	      super(p_173962_);
	   }

	   protected int getBlockLightLevel(LargeCustomFireBall pEntity, BlockPos pPos) {
	      return 0;
	   }

	   public void render(LargeCustomFireBall pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
	    ...
	    */
	   public ResourceLocation getTextureLocation1(LargeCustomFireBall pEntity) {
	      return TEXTURE_LOCATION;
	   }

	@Override
	public ResourceLocation getTextureLocation(LargeCustomFireBall p_114482_) {
		 return TEXTURE_LOCATION;
	}
}